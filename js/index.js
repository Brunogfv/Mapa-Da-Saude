...
function criarHeader() {
    ...
    logo.src = "./imgs/mapa_saude.png";
    logo.alt = "Logo do Mapa da Saúde";

    const nav = document.createElement("nav");

    nav.append(
        criarLink("./index.html", "Home", "active"),
        criarLink("./especialidade.html", "Especialidade"),
        criarLink("./medicos.html", "Médicos"),
        criarLink("./sobre.html", "Sobre"),
        criarLink("./contato.html", "Contato")
    );
...
function criarLink(href, texto, classe = null) {
...
// Criaçao da home a adicionando na section
function criarHome() {
...
// Criação da guia e adicionando na section
function criarGuia() {
...
// Criando o conteúdo dos cards e adicionando na section
function criarCards() {
...
// INIT para melhor organização do body
function initPage() {
